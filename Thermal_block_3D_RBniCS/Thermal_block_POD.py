...
# 3D extension of the thermal toy problem, present in "Reduced Basis Methods for Partial   Differential Equations: An Introduction" by Alfio Quarteroni, Andrea Manzoni and Federico Negri. In this case the sampling is the classical one.

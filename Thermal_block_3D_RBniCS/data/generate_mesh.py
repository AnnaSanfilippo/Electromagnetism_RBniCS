...
with dolfin.XDMFFile("thermal_block_subdomains_tmp.xdmf") as infile:
    infile.read(subdomains_mvc, "subdomains")
subdomains = dolfin.cpp.mesh.MeshFunctionSizet(mesh, subdomains_mvc)
with dolfin.XDMFFile("thermal_block_subdomains.xdmf") as outfile:
    outfile.write(subdomains)
os.remove("thermal_block_subdomains_tmp.xdmf")
os.remove("thermal_block_subdomains_tmp.h5")

# Save boundaries in pygmsh format
meshio.write("thermal_block_boundaries_tmp.xdmf", meshio.Mesh(
    points=pygmsh_mesh.points,
...
with dolfin.XDMFFile("thermal_block_boundaries_tmp.xdmf") as infile:
...
with dolfin.XDMFFile("thermal_block_boundaries.xdmf") as outfile:
    outfile.write(boundaries)
os.remove("thermal_block_boundaries_tmp.xdmf")
os.remove("thermal_block_boundaries_tmp.h5")
